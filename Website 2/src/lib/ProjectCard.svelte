<style>
    ...
    .card:hover .card_expanded {
        ...
        transform: scale(1);    /* Transition from scale(0) -> scale(1) makes .card_expanded pop out from the .card. */
    ...
    .blur {
        background: rgba(0, 0, 0, 0) linear-gradient(to bottom, rgba(0, 0, 0, 0) 10%, rgba(0, 0, 0, .1) 40%, rgba(0, 0, 0, .5) 65%, rgba(0, 0, 0, 1) 100%);
