  ...
  <div class='projects'>
    ...
    <ProjectCard project_name="RC Fireboat"
                 ...
                 description="Used a Raspberry Pi Pico H to build a remote controlled fireboat.
                              It uses [BT/Wifi/IR] and is able to go forwards, backwards, steer
                              left, steer right, and shoot a water cannon. Made for my Microcontroller
                              System Design class."/>
  </div>
  <div class='projects'>
    <h1>Projects</h1>
    <ProjectCardV1 project_name="Falcon Racing &nbsp &nbsp Driver Interface"
                   src='./src/assets/falcon-racing-driver-interface.png'
                  tech_stack={['raspberry-pi', 'python', 'tkinter', 'sqlite']}/>
<ProjectCardV1 project_name="JuiceBox"
    src='./src/assets/placeholder.webp'
    tech_stack={['rust', 'bevy']}/>
<ProjectCardV1 project_name="Terrier &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Web Front-End"
    src='./src/assets/terrier-web-frontend.png'
    tech_stack={['react', 'javascript', 'vite', 'html', 'css', 'figma']}/>
<ProjectCardV1 project_name="Mock-up &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp System Proposal"
    src='./src/assets/mock-up-system-proposal.jpg'
    tech_stack={[]}/>
<ProjectCardV1 project_name="Orbit Simulator"
    src='./src/assets/orbit-simulator.png'
    tech_stack={['javascript', 'html', 'css']}/>
<ProjectCardV1 project_name="Courseflow Generator"
    src='./src/assets/course-flowchart-generator.png'
    tech_stack={['cpp']}/>
<ProjectCardV1 project_name="Graph Library"
    src='./src/assets/java-graph-library.png'
    tech_stack={['java']}/>
<ProjectCardV1 project_name="RC Fireboat"
    {src}
    tech_stack={['raspberry-pi', 'python', 'micro-python']}/>
  </div>
</main>
